...
description: "Mobile App style landing page demo"
type: "homes"
...
sections:
  ...
  - type: "hero2"
    ...
    title: '<span class="text-accent dark:text-white">HugoWind App</span>: <br /> professional websites <span class="hidden xl:inline">made easy</span>'
