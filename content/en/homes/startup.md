...
description: "Startup style landing page demo"
type: "homes"
...
sections:
  ...
  - type: "hero"
    ...
    title: 'Improve <span class="hidden sm:inline">the online presence of</span> your <span class="text-accent dark:text-white">Startup</span> with HugoWind templates'
    subtitle: 'Step into the spotlight with <span class="font-semibold">HugoWind</span> templates, your pathway to fortifying your startup''s digital footprint, fostering credibility, and expanding your reach.'
    actions:
      - variant: "primary"
        text: "Get templates"
  ...
  - type: "brands"
    ...
    subtitle: "At HugoWind, we believe in the power of collaboration to drive innovation and create exceptional experiences."
    images:
